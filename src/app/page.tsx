          ...
          <Tabs aria-label="Options" className="w-full justify-center items-center content-center">
            ...
            <TabPanel className="bg-maincolor-600 grid w-full grid-rows-[auto] md:grid-rows-[40%_auto] p-2 rounded-md md:h-full dark:bg-maincolor-900">
              <section className="flex flex-col md:flex-row bg-maincolor-300 rounded-md dark:bg-maincolor-700">
                <section className="w-full md:w-[25%] p-4 md:ml-5">
                  <h2 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-3xl md:text-6xl dark:text-white">About Me</h2>
                  <p className="text-black font-[family-name:var(--font-kode-bold-mono)] text-sm md:text-base dark:text-white">My name is Hamilton Santiago Insandara Alvarez, i&apos;m 19 years old and I&apos;m a student in the software engineering program at the UCC in Pasto.</p>
                </section>
                <img src="/myphoto.png" className="w-full md:w-[45%] object-contain"></img>
                <p className="text-black w-full md:w-[25%] p-4 text-center md:text-right font-[family-name:var(--font-kode-bold-mono)] text-sm md:text-base dark:text-white">I live in Colombia and I am studying so i can bring my ideas to life through software</p>
              </section>
              <section>
                ...
                <section>
                  <p className="text-black text-center font-[family-name:var(--font-kode-bold-mono)] dark:text-white">I like videogames, music, art and writing</p>
                </section>
              </section>
            </TabPanel>
            <TabPanel className="bg-maincolor-500 w-full p-2 rounded-md h-full grid grid-rows-[80%_auto] dark:bg-maincolor-800">
              <section className="flex flex-col items-center justify-center h-full">
                <h2 className="text-black text-center font-[family-name:var(--font-kode-bold-mono)] text-3xl md:text-6xl dark:text-white">My Projects</h2>
                  ...
                  <Carousel activeIndex={index} onSelect={handleSelect} className="w-[90%]" data-bs-ride="false">
                    <Carousel.Item key={1} className="p-10 rounded-md">
                      <section className="grid lg:grid-cols-[20%_auto] grid-rows-[auto_auto] bg-maincolor-400 rounded-md dark:bg-maincolor-700">
                        ...
                        <section className="bg-maincolor-400 md:m-2 dark:bg-maincolor-700">
                          <p className="text-black font-[family-name:var(--font-kode-bold-mono)] ml-2 dark:text-white">A project created for a university course, consisting of an API that stores and retrieves course information from a database</p>
                          <section className="flex flex-row">
                            ...
                            <p className="text-black pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Java</p>
                          </section>
                          <section className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 dark:fill-white" viewBox="0 0 24 24"><path d="M20.205 16.392c-2.469 3.289-7.741 2.179-11.122 2.338 0 0-.599.034-1.201.133 0 0 .228-.097.519-.198 2.374-.821 3.496-.986 4.939-1.727 2.71-1.388 5.408-4.413 5.957-7.555-1.032 3.022-4.17 5.623-7.027 6.679-1.955.722-5.492 1.424-5.493 1.424a5.28 5.28 0 0 1-.143-.076c-2.405-1.17-2.475-6.38 1.894-8.059 1.916-.736 3.747-.332 5.818-.825 2.208-.525 4.766-2.18 5.805-4.344 1.165 3.458 2.565 8.866.054 12.21zm.042-13.28a9.212 9.212 0 0 1-1.065 1.89 9.982 9.982 0 0 0-7.167-3.031C6.492 1.971 2 6.463 2 11.985a9.983 9.983 0 0 0 3.205 7.334l.22.194a.856.856 0 1 1 .001.001l.149.132A9.96 9.96 0 0 0 12.015 22c5.278 0 9.613-4.108 9.984-9.292.274-2.539-.476-5.763-1.752-9.596"></path></svg>
                            <p className="text-black pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Spring Framework</p>
                          </section>
                        </section>
                      </section>
                      <p className="text-black pt-2 pl-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Course API</p>
                    </Carousel.Item>
                    <Carousel.Item key={2} className="p-10 rounded-md">
                      <section className="grid lg:grid-cols-[20%_auto] grid-rows-[auto_auto] bg-maincolor-400 rounded-md dark:bg-maincolor-700">
                        ...
                        <section className="bg-maincolor-400 m-2 dark:bg-maincolor-700">
                          <p className="text-black font-[family-name:var(--font-kode-bold-mono)] ml-2 dark:text-white">A project created for a university course, it is a basic text editor made in Java using libraries such as JavaSwing and JFrame</p>
                          <section className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 dark:fill-white" viewBox="0 0 24 24"><path d="M9.37 17.51c-3.09.86 1.87 2.64 5.8 1a7.18 7.18 0 0 1-1.1-.54 11.59 11.59 0 0 1-4.16.18c-1.31-.15-.54-.64-.54-.64zm5.33-1.68a16.27 16.27 0 0 1-5.36.26c-1.31-.14-.45-.77-.45-.77-3.4 1.12 1.89 2.4 6.64 1a2.25 2.25 0 0 1-.83-.49zm1.82-9.73s-6.87 1.71-3.59 5.49a1.47 1.47 0 0 1-.25 2.12s2.46-1.27 1.33-2.86-1.86-2.22 2.51-4.75z"></path><path d="M18.13 19.14s.56.46-.63.82c-2.27.69-9.43.9-11.42 0-.72-.31.62-.74 1-.83a2.54 2.54 0 0 1 .69-.08c-.8-.56-5.15 1.1-2.21 1.58 8.05 1.37 14.64-.56 12.57-1.49zm-2.76-4.88a7 7 0 0 1 .92-.49s-1.51.27-3 .4a28.11 28.11 0 0 1-4.82.05C6.09 13.91 9.74 13 9.74 13a6.81 6.81 0 0 0-3.16.75c-2.06 1.03 5.09 1.48 8.79.51zm.91 2.44a.39.39 0 0 1-.08.09c5-1.32 3.18-4.65.78-3.81a.71.71 0 0 0-.33.25s.14-.05.43-.12c1.22-.25 2.92 1.63-.8 3.59zM12 13c-.74-1.67-3.26-3.14 0-5.71C16.09 4.08 14 2 14 2c.84 3.31-3 4.31-4.34 6.37-.93 1.41.47 2.92 2.34 4.63z"></path><path d="M16.41 21.32a29.75 29.75 0 0 1-9.14.14s.46.38 2.84.53c3.61.23 9.15-.12 9.29-1.83 0 0-.26.64-2.99 1.16z"></path></svg>
                            <p className="text-black pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Java</p>
                          </section>
                      ...
                      <p className="text-black pt-2 pl-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Basic Text Editor</p>
                    </Carousel.Item>
                    <Carousel.Item key={3} className="p-10 rounded-md">
                      <section className="grid lg:grid-cols-[20%_auto] grid-rows-[auto_auto] bg-maincolor-400 rounded-md dark:bg-maincolor-700">
                        <img src="/dataStructuresProjects.jpg" className="h-[100%]"></img>
                        <section className="bg-maincolor-400 m-2 dark:bg-maincolor-700">
                          <p className="text-black font-[family-name:var(--font-kode-bold-mono)] ml-2 dark:text-white">A project created for a university course, it is a basic library management system made using Python and TKinter, built specifically to make use of different data structures such as queues, stacks, arrays and linked lists</p>
                          <section className="flex flex-row">
                            ...
                            <p className="text-black pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Python</p>
                          </section>
                        </section>
                      </section>
                      <p className="text-black pt-2 pl-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Book Management System</p>
                    </Carousel.Item>
                    <Carousel.Item key={4} className="p-10 rounded-md">
                      <section className="grid lg:grid-cols-[20%_auto] grid-rows-[auto_auto] bg-maincolor-400 rounded-md dark:bg-maincolor-700">
                        ...
                        <section className="bg-maincolor-400 m-2 dark:bg-maincolor-700">
                          ...
                          <section className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 dark:fill-white" viewBox="0 0 24 24"><path d="M7.533 12.249c-.011 1.985 1.445 3.168 3.768 2.63V9.618c-2.352-.716-3.758.733-3.768 2.631m3.839-10.238h3.199v15.143c-3.066.501-6.004.819-8.104-.355-2.705-1.513-2.923-6.319-.782-8.46 1.085-1.085 3.271-1.85 5.616-1.351V2.225c-.006-.101-.012-.202.071-.214m8.389 3.342h-3.199V2.011h3.199v3.342z"></path><path d="M19.761 7.044c-.003 2.356-.003 4.048-.003 6.911-.136 2.813-.104 5.052-1.135 6.398-.203.266-.634.652-.995.924-.303.228-.881.691-1.208.711-.331.021-1.18-.459-1.564-.64-.505-.237-.971-.553-1.493-.71 1.218-.754 2.372-1.32 2.844-2.844.41-1.326.355-3.247.355-5.119 0-1.849.009-3.998.009-5.63l3.19-.001z"></path></svg>
                            <p className="text-black pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Django</p>
                          </section>
                          <section className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 dark:fill-white" viewBox="0 0 24 24"><path d="M4.136 3.012h15.729l-1.431 16.15-6.451 1.826-6.414-1.826-1.433-16.15zm5.266 7.302-.173-2.035 7.533.002.173-1.963-9.87-.002.522 5.998h6.835l-.243 2.566-2.179.602-2.214-.605-.141-1.58H7.691l.247 3.123L12 17.506l4.028-1.08.558-6.111H9.402v-.001z"></path></svg>
                            <p className="text-black pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">HTML</p>
                          </section>
                          <section className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 dark:fill-white" viewBox="0 0 24 24"><path d="M19.24 3H4.76A1.76 1.76 0 0 0 3 4.76v14.48A1.76 1.76 0 0 0 4.76 21h14.48A1.76 1.76 0 0 0 21 19.24V4.76A1.76 1.76 0 0 0 19.24 3zm-5.8 10h-2.25v6.44H9.4V13H7.15v-1.46h6.29zm5.8 5.28a1.71 1.71 0 0 1-.67.74 3 3 0 0 1-1 .39 5.81 5.81 0 0 1-1.2.12 7 7 0 0 1-1.23-.11 4.52 4.52 0 0 1-1-.33v-1.71l-.06-.06h.06v.07a3.41 3.41 0 0 0 1 .54 3.06 3.06 0 0 0 1.13.2 2.58 2.58 0 0 0 .6-.06 1.47 1.47 0 0 0 .42-.17.75.75 0 0 0 .25-.25.69.69 0 0 0-.06-.74 1.24 1.24 0 0 0-.35-.33 3.12 3.12 0 0 0-.53-.3l-.67-.28a3.57 3.57 0 0 1-1.37-1 2 2 0 0 1-.46-1.33 2.16 2.16 0 0 1 .24-1.06 2.09 2.09 0 0 1 .66-.71 2.88 2.88 0 0 1 1-.42 5.11 5.11 0 0 1 1.19-.13 7 7 0 0 1 1.09.07 4.53 4.53 0 0 1 .88.23v1.65a2.42 2.42 0 0 0-.42-.24 3.58 3.58 0 0 0-.49-.17 3 3 0 0 0-.49-.1 2.45 2.45 0 0 0-.46 0 2.29 2.29 0 0 0-.56.06 1.54 1.54 0 0 0-.43.16.78.78 0 0 0-.26.25.63.63 0 0 0-.09.33.62.62 0 0 0 .1.35 1.19 1.19 0 0 0 .3.29 2.15 2.15 0 0 0 .46.28l.63.28a6.56 6.56 0 0 1 .84.42 2.65 2.65 0 0 1 .64.49 1.79 1.79 0 0 1 .42.63 2.48 2.48 0 0 1 .14.85 2.68 2.68 0 0 1-.25 1.08z"></path></svg>
                            <p className="text-black pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Typescript</p>
                          </section>
                          <section className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 dark:fill-white" viewBox="0 0 24 24"><path d="M10.483 12.482h3.034L12 8.831z"></path><path d="M12 3.074 3.689 6.038l1.268 10.987 7.043 3.9 7.043-3.9 1.268-10.987L12 3.074zm5.187 13.621H15.25l-1.045-2.606h-4.41L8.75 16.695H6.813L12 5.047l5.187 11.648z"></path></svg>
                            <p className="text-black pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Angular</p>
                          </section>
                        </section>
                      </section>
                      <p className="text-black pt-2 pl-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">LinkedIn Like Webpage</p>
                    </Carousel.Item>
                    <Carousel.Item key={5} className="p-10 rounded-md">
                      ...
                      <p className="text-black pt-2 pl-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Basic Hospital Management System</p>
                    </Carousel.Item>
                  </Carousel>
                </section>
              </section>
            ...
            <TabPanel className="bg-maincolor-400 grid w-full grid-rows-[40%_auto] p-2 rounded-md h-full dark:bg-maincolor-700">
              <section className="items-center justify-center">
                <h2 className="text-black md:w-[40%] font-[family-name:var(--font-kode-bold-mono)] text-3xl dark:text-white">Academic And Laboral Experiences</h2>
                <section className="flex items-center flex-col">
                  <section className="grid grid-rows-[auto_auto_auto] md:grid-cols-[20%_50%_30%] mt-10">
                    <section className="mt-3 md:border-solid md:border-t-2 md:border-black dark:border-white">
                      <p className="text-black font-[family-name:var(--font-kode-bold-mono)] invisible dark:text-white">-------------</p>
                    </section>
                    <section className="">
                      <h3 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-3xl dark:text-white">Academic Experience</h3>
                      <p className="text-black font-[family-name:var(--font-kode-bold-mono)] dark:text-white">At University I have been able to create several projects using languages such as Python, Java, html, etc and some frameworks such as Tailwind and Springboot, while also learning about good practices while coding and the different stages of software development, i also have the chance of sharing and collaborating with my peers, learning about teamwork and soft skills </p>
                    </section>
                    <section>
                  ...
                  <section className="grid md:grid-cols-[30%_50%_20%] grid-rows-[auto_auto_auto] mt-10">
                    ...
                    <section className="items-end row-start-1 md:col-start-2 md:row-span-full">
                      <h3 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-3xl text-end dark:text-white">Laboral Experience</h3>
                      <p className="text-black font-[family-name:var(--font-kode-bold-mono)] text-end dark:text-white">Currently i do not have experience within the field of software development, so far, i have only worked on a small grocery shop.</p>
                    </section>
            ...
            <TabPanel className="bg-maincolor-300 grid w-full grid-rows-[40%_auto] p-2 rounded-md h-full dark:bg-maincolor-600">
              <section className="items-center justify-center">
                <h2 className="text-black md:w-[40%] font-[family-name:var(--font-kode-bold-mono)] text-3xl dark:text-white">
                ...
                <section className="flex items-center md:flex-row flex-col">
                  ...
                  <section className="flex flex-column p-3">
                    {experiences.map((experience, index) => (
                      ...
                      >
                        <h3 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-3xl dark:text-white">
                          {experience.title}
                        </h3>
                        <p className="text-black font-[family-name:var(--font-kode-bold-mono)] dark:text-white">
            ...
            <TabPanel className="bg-maincolor-200 grid w-full grid-rows-[auto] md:grid-rows-[40%_auto] p-2 rounded-md h-full dark:bg-maincolor-500">
              <section className="items-center justify-center">
                <h2 className="text-black w-full md:w-[40%] font-[family-name:var(--font-kode-bold-mono)] text-3xl dark:text-white">Contact Me</h2>
                <section className="bg-maincolor-300 p-2 rounded-lg m-2 flex flex-col md:flex-row items-center justify-center dark:bg-maincolor-600">
                  <section className="md:justify-center p-2 border-solid md:border-r-2 border-b-2 md:border-b-0 border-black w-full md:w-auto">
                    ...
                    <h3 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-3xl text-center dark:text-white">Personal Email</h3>
                    <p className="text-black font-[family-name:var(--font-kode-bold-mono)] text-sm md:text-base text-center dark:text-white">hamisan36@gmail.com</p>
                  </section>
                  <section className="md:justify-center p-2 border-solid md:border-r-2 border-b-2 md:border-b-0 border-black w-full md:w-auto">
                    ...
                    <h3 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-3xl text-center dark:text-white">Phone Number</h3>
                    <p className="text-black font-[family-name:var(--font-kode-bold-mono)] text-sm md:text-base text-center dark:text-white">3148308355</p>
                  </section>
                  <section className="md:justify-center p-2 md:border-b-0 w-full md:w-auto">
                    ...
                    <h3 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-wrap text-3xl text-center dark:text-white">Institutional Email</h3>
                    <p className="text-black font-[family-name:var(--font-kode-bold-mono)] text-wrap text-sm md:text-base text-center dark:text-white">hamilton.insandara@campusucc.edu.co</p>
                  </section>
                </section>
              </section>
            </TabPanel>
            <TabPanel className="bg-maincolor-100 grid w-full grid-rows-[40%_auto] p-2 rounded-md h-full dark:bg-maincolor-400">
              <section className="items-center justify-center">
                <h2 className="text-black md:w-[40%] w-full font-[family-name:var(--font-kode-bold-mono)] text-3xl dark:text-white">Technical Skills and Tools</h2>
                <section className="items-center bg-maincolor-300 flex flex-col xl:flex-row rounded-md dark:bg-maincolor-600">
                  <section className="flex flex-col">
                    <section className="bg-maincolor-400 p-2 rounded-lg m-5 border-solid border-black border-1 flex md:flex-row flex-col dark:bg-maincolor-500">
                      <section>
                        <h5 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-2xl dark:text-white">Java</h5>
                        <p className="text-black font-[family-name:var(--font-kode-bold-mono)] dark:text-white">I am familiar with the usage of the java language due to its usage within our university projects</p>
                      </section>
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-56 md:-mr-12 dark:fill-white" viewBox="0 0 24 24"><path d="M9.37 17.51c-3.09.86 1.87 2.64 5.8 1a7.18 7.18 0 0 1-1.1-.54 11.59 11.59 0 0 1-4.16.18c-1.31-.15-.54-.64-.54-.64zm5.33-1.68a16.27 16.27 0 0 1-5.36.26c-1.31-.14-.45-.77-.45-.77-3.4 1.12 1.89 2.4 6.64 1a2.25 2.25 0 0 1-.83-.49zm1.82-9.73s-6.87 1.71-3.59 5.49a1.47 1.47 0 0 1-.25 2.12s2.46-1.27 1.33-2.86-1.86-2.22 2.51-4.75z"></path><path d="M18.13 19.14s.56.46-.63.82c-2.27.69-9.43.9-11.42 0-.72-.31.62-.74 1-.83a2.54 2.54 0 0 1 .69-.08c-.8-.56-5.15 1.1-2.21 1.58 8.05 1.37 14.64-.56 12.57-1.49zm-2.76-4.88a7 7 0 0 1 .92-.49s-1.51.27-3 .4a28.11 28.11 0 0 1-4.82.05C6.09 13.91 9.74 13 9.74 13a6.81 6.81 0 0 0-3.16.75c-2.06 1.03 5.09 1.48 8.79.51zm.91 2.44a.39.39 0 0 1-.08.09c5-1.32 3.18-4.65.78-3.81a.71.71 0 0 0-.33.25s.14-.05.43-.12c1.22-.25 2.92 1.63-.8 3.59zM12 13c-.74-1.67-3.26-3.14 0-5.71C16.09 4.08 14 2 14 2c.84 3.31-3 4.31-4.34 6.37-.93 1.41.47 2.92 2.34 4.63z"></path><path d="M16.41 21.32a29.75 29.75 0 0 1-9.14.14s.46.38 2.84.53c3.61.23 9.15-.12 9.29-1.83 0 0-.26.64-2.99 1.16z"></path></svg>
                    </section>
                    <section className="bg-maincolor-400 p-2 rounded-lg m-5 border-solid border-black border-1 flex md:flex-row flex-col dark:bg-maincolor-500">
                      <section>
                        <h5 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-2xl dark:text-white">Python</h5>
                        <p className="text-black font-[family-name:var(--font-kode-bold-mono)] dark:text-white">I am familiar with the usage of python, learning it through university and independently through the internet</p>
                      </section>
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-56 md:-mr-12 dark:fill-white" viewBox="0 0 24 24"><path d="M9.585 11.692h4.328s2.432.039 2.432-2.35V5.391S16.714 3 11.936 3C7.362 3 7.647 4.983 7.647 4.983l.006 2.055h4.363v.617H5.92s-2.927-.332-2.927 4.282 2.555 4.45 2.555 4.45h1.524v-2.141s-.083-2.554 2.513-2.554zm-.056-5.74a.784.784 0 1 1 0-1.57.784.784 0 1 1 0 1.57z"></path><path d="M18.452 7.532h-1.524v2.141s.083 2.554-2.513 2.554h-4.328s-2.432-.04-2.432 2.35v3.951s-.369 2.391 4.409 2.391c4.573 0 4.288-1.983 4.288-1.983l-.006-2.054h-4.363v-.617h6.097s2.927.332 2.927-4.282-2.555-4.451-2.555-4.451zm-3.981 10.436a.784.784 0 1 1 0 1.57.784.784 0 1 1 0-1.57z"></path></svg>
                    </section>
                    <section className="bg-maincolor-400 p-2 rounded-lg m-5 border-solid border-black border-1 flex md:flex-row flex-col dark:bg-maincolor-500">
                      <section>
                        <h5 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-2xl dark:text-white">C++</h5>
                        <p className="text-black font-[family-name:var(--font-kode-bold-mono)] dark:text-white">I learned  c++ to a basic level through independent means</p>
                      </section>
                  ...
                  <section className="flex flex-col">
                    <section className="bg-maincolor-400 p-2 rounded-lg m-5 border-solid border-black border-1 flex md:flex-row flex-col dark:bg-maincolor-500">
                      ...
                      <section>
                        <h5 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-2xl dark:text-white">English</h5>
                        <p className="text-black font-[family-name:var(--font-kode-bold-mono)] dark:text-white">As of now, my English level is considered to be B2, and I can understand both written and spoken English, as well as write and speak it myself.</p>
                      </section>
                    </section>
                    <section className="bg-maincolor-400 p-2 rounded-lg m-5 border-solid border-black border-1 flex md:flex-row flex-col dark:bg-maincolor-500">
                      ...
                      <section>
                        <h5 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-2xl dark:text-white">Web Development</h5>
                        <p className="text-black font-[family-name:var(--font-kode-bold-mono)] dark:text-white">I have basic experience with the usage of basic web development tools such as javascript, html and css</p>
                      </section>
                    </section>
                    <section className="bg-maincolor-400 p-2 rounded-lg m-5 border-solid border-black border-1 flex md:flex-row flex-col dark:bg-maincolor-500">
                      ...
                      <section>
                        <h5 className="text-black font-[family-name:var(--font-kode-bold-mono)] text-2xl dark:text-white">Spring Boot</h5>
                        <p className="text-black font-[family-name:var(--font-kode-bold-mono)] dark:text-white">I have used spring boot to create a java API REST in university</p>
                      </section>
                    </section>
                  </section>
                </section>
