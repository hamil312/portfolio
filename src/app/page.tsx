                      ...
                      <section className="grid lg:grid-cols-[20%_auto] grid-rows-[auto_auto] bg-maincolor-400 rounded-md dark:bg-maincolor-700">
                        ...
                        <section className="bg-maincolor-400 md:m-2 dark:bg-maincolor-700">
                          ...
                          <section className="flex flex-row">
                            ...
                            <p className="pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Spring Framework</p>
                          </section>
                        </section>
                      </section>
                      ...
                      <section className="grid lg:grid-cols-[20%_auto] grid-rows-[auto_auto] bg-maincolor-400 rounded-md dark:bg-maincolor-700">
                        ...
                        <section className="bg-maincolor-400 m-2 dark:bg-maincolor-700">
                          ...
                          <section className="flex flex-row">
                            ...
                            <p className="pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Django</p>
                          </section>
                          <section className="flex flex-row">
                            ...
                            <p className="pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">HTML</p>
                          </section>
                          <section className="flex flex-row">
                            ...
                            <p className="pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Typescript</p>
                          </section>
                          <section className="flex flex-row">
                            ...
                            <p className="pt-2 ml-2 font-[family-name:var(--font-kode-bold-mono)] text-xl dark:text-white">Angular</p>
                          </section>
                        </section>
                      </section>
